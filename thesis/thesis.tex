...
This rises the need for novel data, recorded under controlled conditions. \todo{Because this is an intensive task}. Rather than recording this novel data, one could synthesize this data using albedo and surface normal recovery from present data. \\[10px]
