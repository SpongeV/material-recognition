...
To overcome this problem, one could use a RANSAC approach and sample multiple surface albedos from the image data and compare them to detect outliers. However, this would make the comparison with Targhi's experiments difficult when using a minimal amount of training images for texture synthesis.
