...
\noindent where D is the proportionate number of microfacets facing the direction in the direction of $\alpha$. In our case this would be the angle between the halfway vector $\vec{\mathbf{h}}$ and surface normal $\vec{\mathbf{n}}$.
